...
class models():
    ...
    def NaiveBase(self, filename, cvnr=4500, test_size=0.25):
        dataset = pd.read_excel(DataSource.path + filename)
        # for first run uncomment below
    ...
    def RandomForest(self, filename, cvnr=4500, test_size=0.25, n_estimators = 10):
